  ...
  return (
    <>
      <motion.button
        ...
        className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 disabled:cursor-not-allowed disabled:!opacity-50"
      >
  ...
  return (
    <div className="dropdown">
      <motion.button
        ...
        tabIndex={0}
        role="button"
        className="btn btn-primary btn-sm lg:btn-md btn-outline m-1 !pointer-events-auto"
        disabled={loading}
        onClick={handleFocus}
      >
        {btnText}
